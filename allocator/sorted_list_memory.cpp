...
logger * sorted_list_memory::get_logger() const
{
...
size_t sorted_list_memory::get_occupied_block_size_without_service_block(void * current_block) const
{
    return get_occupied_block_size(current_block) - get_occupied_block_service_block_size();
}

void * sorted_list_memory::get_start_allocated_memory_address() const
{
    return reinterpret_cast<void*>(reinterpret_cast<unsigned char*>(_allocated_memory) + get_allocator_service_block_size());
}

void * sorted_list_memory::get_address_relative_to_allocator(void * current_block_address) const
{
