#include "borders_descriptors_memory.h"

size_t borders_descriptors_memory::get_allocator_service_block_size() const
{
    return sizeof(size_t) + sizeof(memory*) + sizeof(logger*) + sizeof(memory::allocation_mode) + sizeof(void*);
}

size_t borders_descriptors_memory::get_allocated_memory_size() const
{
...
logger * borders_descriptors_memory::get_logger() const
{
    return *reinterpret_cast<logger**>(reinterpret_cast<unsigned char*>(_allocated_memory) + sizeof(size_t) + sizeof(memory*));
}

memory::allocation_mode borders_descriptors_memory::get_allocation_mode() const
{
...
void* borders_descriptors_memory::get_first_occupied_block() const
{
...
void** borders_descriptors_memory::get_first_occupied_block_ptr() const
{
    return reinterpret_cast<void**>(reinterpret_cast<unsigned char*>(_allocated_memory) + sizeof(size_t) + sizeof(memory*) + sizeof(logger*) + sizeof(allocation_mode));
}

void * borders_descriptors_memory::get_next_occupied_block(void * current_block) const
{
    return *reinterpret_cast<void**>(reinterpret_cast<unsigned char*>(current_block) + sizeof(size_t) + sizeof(void*));
}

void * borders_descriptors_memory::get_previous_occupied_block(void *current_block) const
{
    return *reinterpret_cast<void**>(reinterpret_cast<unsigned char*>(current_block) + sizeof(size_t));
}

size_t borders_descriptors_memory::get_available_block_size(void * next_occupied_block_to_target_block) const
{
...
size_t borders_descriptors_memory::get_occupied_block_service_block_size() const
{
    return sizeof(size_t) + sizeof(void *) + sizeof(void *);
}

size_t borders_descriptors_memory::get_occupied_block_size(void * current_block) const
{
    return *reinterpret_cast<size_t*>(current_block);
}

size_t borders_descriptors_memory::get_occupied_block_size_without_service_block(void * current_block) const
{
...
void * borders_descriptors_memory::get_start_allocated_memory_address() const
{
    return reinterpret_cast<void*>(reinterpret_cast<unsigned char*>(_allocated_memory) + get_allocator_service_block_size());
}

void * borders_descriptors_memory::get_end_allocated_memory_address() const
{
    return reinterpret_cast<void*>(reinterpret_cast<unsigned char*>(_allocated_memory) + get_allocated_memory_size());
}

void * borders_descriptors_memory::get_address_relative_to_allocator(void * current_block_address) const
{
...
void borders_descriptors_memory::deallocate(void * target_to_dealloc) const
{
